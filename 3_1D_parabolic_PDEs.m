% Program for solving Parabolic PDE's in 1D with explicit Euler,
% Method of Lines and comparison to Matlab's build in functions
% du/dt = Au + b; u(0) = 0
%
% as of 03st Nov. 2022
...
%% solving with explicit Euler and Method of lines
...
%% Comparison with the MATLAB inbuild function ode23(s/sJ)
% parameters
N=400       
hx = L/N;
a=0.3;      
